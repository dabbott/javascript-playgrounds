...
[Try it out!](https://unpkg.com/react-native-web-player@2.0.0-alpha.20/public/index.html#title=React%20Native%20Web%20Player)
...
<iframe
  ...
  height="425"
  frameborder="0"
  src="//unpkg.com/react-native-web-player@2.0.0-alpha.20/public/index.html"
></iframe>
```
...
- Find-and-replace the version, `2.0.0-alpha.20`, throughout the project with the desired version using your IDE or terminal (this is somewhat manual, but is easy enough that I haven't scripted it yet)
- `npm publish`
- `npm run gh-pages`
