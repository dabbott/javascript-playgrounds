...
[Try it out!](https://cdn.rawgit.com/dabbott/react-native-web-player/gh-v2.0.0-alpha.6/index.html#title=React%20Native%20Web%20Player)
...
```html
<iframe width="880" height="425" frameborder="0" src="//cdn.rawgit.com/dabbott/react-native-web-player/gh-v2.0.0-alpha.6/index.html"></iframe>
```
...
```html
<iframe width="880" height="425" frameborder="0" src="//cdn.rawgit.com/dabbott/react-native-web-player/v2.0.0-alpha.6/index.html"></iframe>
```
