...
[Try it out!](https://npmcdn.com/react-native-web-player@1.0.0/index.html#title=React%20Native%20Web%20Player)
...
```html
<iframe width="880" height="425" frameborder="0" src="//npmcdn.com/react-native-web-player@1.0.0/index.html"></iframe>
```
...
```html
<iframe width="880" height="425" frameborder="0" src="//cdn.rawgit.com/dabbott/react-native-web-player/v1.0.0/index.html"></iframe>
```
...
- Custom code - https://npmcdn.com/react-native-web-player@1.0.0/index.html#platform=ios&code=import%20React%2C%20%7B%20Component%2C%20%7D%20from%20'react'%3B%0Aimport%20%7B%20AppRegistry%2C%20Text%2C%20%7D%20from%20'react-native'%3B%0A%0Aconst%20App%20%3D%20()%20%3D%3E%20%3CText%3EHello%20World%3C%2FText%3E%3B%0A%0AAppRegistry.registerComponent('App'%2C%20()%20%3D%3E%20App)%3B
- Android device - https://npmcdn.com/react-native-web-player@1.0.0/index.html#platform=android
- Custom title - https://npmcdn.com/react-native-web-player@1.0.0/index.html#title=Hello%20Title
